...
namespace HikePOS
{
    public partial class EnterSalePage : BaseContentPage<EnterSaleViewModel>
    {

        public static bool DataUpdated = true;
        public static bool PaymentActiveUpdated = false;
        ...
        public EnterSalePage()
        {
            InitializeComponent();
            ViewModel.EnterSalePage = this;
            //#97186 By PR
            if (ViewModel.invoicemodel?.CustomerModel != null)
                ViewModel.invoicemodel.CustomerModel.SearchCustomerView = CustomerPopup;
            //#97186 By PR 
        ...
        public void ScrollCategoryToStart()
        {
            BottomMenuListView.ScrollTo(0);
        }
