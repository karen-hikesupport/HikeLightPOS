...
namespace HikePOS
{
    ...
    public partial class ParkSalePage : BaseContentPage<ParkSaleViewModel>
    {
            ...
            _= Task.Run(async () => 
            {
                ...
                try
                {
                    MainThread.BeginInvokeOnMainThread(() =>
                    {
                        ...
                        {
                            ParkSaleFilterOutletMenuView.LoadOutlets();
       ...
       /* private async void ParkedListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
        ...
        private void CustomerName_Unfocused(object sender, FocusEventArgs e)
        {
            ViewModel.UpdateCustomerUnfocusedCommand.Execute((Entry)sender);
        }

        private void SearchSaleEntry_TextChanged(object sender, TextChangedEventArgs e)
        {
            ViewModel.SearchHandleTextChangedCommand.Execute((Entry)sender);
